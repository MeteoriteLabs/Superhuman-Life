    ...
    return (
        <Container fluid>
            ...
            <Row className="text-center bg-dark py-2">
                ...
                <h5 className="text-light col-lg-12 col-sm-12">
                    All your data and account will be deleted 30 days.
                </h5>
            </Row>
            ...
            <Row className="text-center py-5">
                ...
                <h5 className="col-lg-12 col-sm-12">
            ...
            <Row className="text-center py-4 px-3 fixed-bottom bg-dark">
                <h5 className="text-light col-lg-12 col-sm-12">
                    “Change makers take risks and are ready to die for excellence than to give
                    excuses and live for mediocrity.”
                </h5>
            </Row>
        </Container>
    )
