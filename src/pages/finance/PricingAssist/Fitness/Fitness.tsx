...
export default function Fitness() {
                    ...
                    return currValue.Modes.Channel.map((channelMode: string[]) => {
                        ...
                        return {
                            ...
                            updatedAt:
                                indexOfPackage !== -1
                                    ? moment(
                                          flattenSuggestedPricing.suggestedPricings[indexOfPackage]
                                              .updatedAt
                                      ).format('MMMM DD,YYYY')
                                    : '',
    ...
    return (
        <div className="mt-5">
            <p>
                This base pricing will be used to help you price your offerings. It will suggest you
                the calculated price based mode, duration and type of offering.
            </p>
            <Row>
                <Col>
