    ...
    return (
        <div className=" container">
            <div
                ...
                style={{ backgroundColor: '#e4e4e499' }}
            >
                <div>
                    <h1>Invoice</h1>
                    <p>
                        <span className="font-weight-bold">Invoice No.</span>: 10101010{' '}
                    </p>
                    <p>
                        <span className="font-weight-bold">Date</span>: {rowData.bookingDate}
                    </p>
                </div>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center px-4  mt-5">
                ...
                <div className="text-right" style={{ width: '40%' }}>
                    ...
                    {typeof rowData.clientAddress === 'object'
                        ? rowData.clientAddress.map((item) => {
                              return (
                                  <p>
            ...
            <div
                ...
                style={{ borderTop: '1px solid gray', marginTop: '10rem' }}
            >
                <div>
                    <p className="mb-0 font-weight-bold">Contact Changemaker</p>
                    <p>
                        {rowData.userInfo.Firstname || 'Missing first name'}{' '}
                        {rowData.userInfo.Lastname || 'Missing last name'}
                    </p>
                </div>
                <p>www.abc.com</p>
