                ...
                return {
                    client:
                        fitnessPackage.attributes.ClientUser.data.length > 0
                            ? fitnessPackage.attributes.ClientUser.data[0].attributes.username
                            : 'N/A',
                    clientPhoneNumber:
                        fitnessPackage.attributes.ClientUser.data.length > 0
                            ? fitnessPackage.attributes.ClientUser.data[0].Phone_Number
                            : 'N/A',
                    clientAddress:
                        fitnessPackage.attributes.ClientUser.data.length > 0
                            ? fitnessPackage.attributes.ClientUser.data[0].addresses
                            : 'N/A',
                    ...
                    packageName:
                        fitnessPackage.attributes.fitnesspackages.data[0].attributes.packagename,
