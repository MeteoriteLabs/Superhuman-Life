...
export default function ForgotPassword() {
    ...
    const [resetPassword] = useMutation(RESET_PASSWORD, { onCompleted: () => { setEmailSent(true) } });

  
    function onSubmit(formData: any) {
      resetPassword({ variables: { pass: formData.password, confirmPass: formData.confirm, code: code } });
    }
      ...
      {emailSent && 
            <div>
                <Row style={{ justifyContent: 'center', justifyItems: 'center'}}>
                    <h1 style={{color: '#30962E'}}><img src="/assets/confirmed.svg" alt="confirmed"></img>Password Updated</h1>
                </Row>
