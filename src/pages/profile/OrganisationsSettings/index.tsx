    ...
    return (
        <Container>
            ...
            <Row className="justify-content-between">
                ...
                <Button variant="outline-dark" className='float-right'>New Organisation</Button>
            </Row>

            {organizations.length && organizations.map((data: any, index: number) =>
                    ...
                    <Col lg={12}>
                        <Card>
                            <Card.Body >
                                ...
                                <Row className="p-2">
                                    <Col lg={6} xs={12}>
                                        <Row><b>{data.Organization_Name ? data.Organization_Name : null}</b></Row>
                                        <Row>Ring Road near Palasia, Indore (M.P.)</Row>
                                    </Col>
                                    <Col lg={6} xs={12}>
                                        <Row><b>Admin Name:</b> @michael @vikas</Row>
                                        <Row><b>Team :</b> @michael @vikas </Row>
                                        <Row><b>Categories:</b> Fitness, Nutrition, Mental Health</Row>
                                    </Col>
