        ...
        onCompleted: (response) => {
            ...
            setEducationID(
                response.usersPermissionsUser.data.attributes.educational_details.data &&
                    response.usersPermissionsUser.data.attributes.educational_details.data.length
                    ? response.usersPermissionsUser.data.attributes.educational_details.data.map(
                          (eduId) => eduId.id
                      )
                    : null
            )
        ...
        <>
            ...
            {isFormSubmitted ? (
                <Toaster
                    ...
                    type="success"
                    msg="New education detail has been added"
                />
            ) : null}

            {isEducationDeleted ? (
                <Toaster
                    handleCallback={() => setIsEducationDeleted(!isEducationDeleted)}
                    type="success"
                    msg="Education Detail has been deleted successfully"
                />
            ) : null}

            {isEducationUpdated ? (
                <Toaster
                    handleCallback={() => setIsEducationUpdated(!isEducationUpdated)}
                    type="success"
                    msg="Education Detail has been updated successfully"
                />
            ) : null}
        </>
    )
