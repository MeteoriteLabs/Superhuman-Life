    ...
    return (
        <>
            <Card>
                ...
                <Tabs defaultActiveKey="actionRequired" className="d-flex justify-content-center">
                                      ...
                                      .map((currentValue, index: number) => (
                                          ...
                                          >
                                              <div className="col-lg-12">
                                                  <b>
                                                      Change status for {currentValue.packagename}
                                                  </b>
                                                  <p>
                                                      Please change the status to publish this
                                                      offering
                                                  </p>
                                                  <p>
                                      ...
                                      .map((currentValue, index: number) => (
                                          ...
                                          >
                                              <div className="col-lg-12">
                                                  ...
                                                  <p>
                                                      Please create the whole program to publish
                                                      this offering
                                                  </p>
                    ...
                    <Tab eventKey="profile" title="Completed">
                        <div className="scrollBar pt-3 ">
                            {notPendingBookings &&
                            notPendingBookings.length === 0 &&
                            dataTable &&
                            dataTable.length === 0 ? (
                                <NoDataInCard
                                    msg={'No accepted / rejected bookings and offerings to show'}
                                />
                            ) : null}
                            {dataTable && dataTable.length
                                ? dataTable
