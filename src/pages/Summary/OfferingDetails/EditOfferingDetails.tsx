...
const EditOffering: React.FC<{ show: boolean; onHide: () => void; Offering: ClientBooking; }> = ({ show, onHide, Offering }) => {
  const editOfferingJson: { [name: string]: any } = require('./EditOffering.json');
  const formData: DefaultClientBooking = {offerings: Offering.fitnesspackages[0].packagename,
