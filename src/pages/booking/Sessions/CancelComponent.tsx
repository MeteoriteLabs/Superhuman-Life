...
function CancelComponent(props: any, ref: any) {
  ...
  const [getSession, { data: get_session, refetch: refetch_session }] =
  ...
  const changeScheduleHandler = (id: string, selectedTime: any) => {
    ...
    const sessionBookingArray =
      ...
      selectedSession.sessions_bookings.map(
    ...
    const feedbackNotesArray =
      ...
      selectedSession.feedback_notes.map(
        (currentValue: any) => currentValue.id
      );
            ...
            data: {
              ...
              session_date:
                selectedSession && selectedSession.session_date
                  ...
                  : null,
              tag:
                selectedSession && selectedSession.tag
                  ? selectedSession.tag
                  : null,
              type:
