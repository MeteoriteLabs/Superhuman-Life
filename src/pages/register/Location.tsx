...
const LocationForm = (props: any) => {
    ...
    return (
        <>
            <div>
                <Button variant='info' onClick={() => window.navigator.geolocation.getCurrentPosition(successCallback, failureCallback)}>
                    <i className='fas fa-search-location mr-2'></i>Use Current Location</Button>
            </div>
            <br />
            <Form>
