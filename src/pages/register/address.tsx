...
const Address = (props: any) => {
     ...
     const [state, setState] = useState(props.value === undefined ? '' : JSON.parse(props.value).state);
     const [zip, setZip] = useState(props.value === undefined ? '' : JSON.parse(props.value).zip);
     const [country, setCountry] = useState(props.value === undefined ? '' : JSON.parse(props.value).country);
     const [addressTitle, setAddressTitle] = useState(props.value === undefined ? '' : JSON.parse(props.value).addressTitle)
     ...
     props.onChange(JSON.stringify({address1: address1, address2: address2, city: city, state: state, zip: zip, country: country, addressTitle: addressTitle}));
     ...
     return (
          <div>
               ...
               <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control value={address2} onChange={(e) => setAddress2(e.target.value)} type="text" placeholder="" />
               </Form.Group>
               <Form.Group controlId="formBasicEmail">
               ...
               <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control value={addressTitle} onChange={(e) => setAddressTitle(e.target.value)} type="text" placeholder="" />
               </Form.Group>
          </div>
     );
};
