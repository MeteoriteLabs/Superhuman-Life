    ...
    <div>
      ...
      {props?.title1 && (
        <span className="small">
          SOffering will be visible on the website and app only from the above
          date
        </span>
      )}
      ...
      {props?.title2 && (
        <span className="small">
          Offering will go into drafts and will be remove from listing on
          webiste and app
        </span>
      )}
    </div>
