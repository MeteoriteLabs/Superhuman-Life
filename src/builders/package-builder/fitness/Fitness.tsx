                        ...
                        <div>
                            ...
                            {row.original.type === 'Event' ? (
                                <div>
                                    <img
                                        loading="lazy"
                                        src="./assets/offeringImages/Event.svg"
                                        alt="EventType"
                                    />
                                </div>
                            ) : (
                                    ...
                                    title={`${
                                        Object.keys(sessionsObj).length
                                            ? `Start date: ${moment(row.original.startDate).format(
                                                  'DD-MM-YYYY'
                                              )} - End date: ${moment(row.original.endDate).format(
                                                  'DD-MM-YYYY'
                                              )},${
