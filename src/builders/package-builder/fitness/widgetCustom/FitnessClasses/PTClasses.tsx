...
const PTClasses: React.FC<Props> = (props) => {
  ...
  const handleValidationFor30Day = (e: { target: any }, widgetProps: { label: string }) => {
    ...
    if (widgetProps.label === 'Online') {
      ...
      dayAvailableRef.current -= parseInt(e.target.value) + props.PTProps.ptofflineClasses.value + props.PTProps.restDay.value;
      ...
      dayAvailableRef.current -= parseInt(e.target.value) + props.PTProps.ptonlineClasses.value + props.PTProps.restDay.value;
