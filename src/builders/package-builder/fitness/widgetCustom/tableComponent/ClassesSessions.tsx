...
export default function ClassesSessions(props) {
    let { type, classOnline, classOffline, classicClasses, ptonline, ptoffline, grouponline, groupoffline, recordedclasses } = props;
    ...
    if (type === "Classic Class") {
        ...
        totalClasses = ptonline + ptoffline + grouponline + groupoffline + recordedclasses
