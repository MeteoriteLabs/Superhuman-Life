...
const BookingConfig = (props: any) => {
     ...
     useEffect(() => {
          ...
          if(handleValidation()){
               props.onChange(JSON.stringify({config: config, fillSchedule: fillSchedule}));
          }else {
     ...
     return (
          <>
               ...
               <Col>
                    ...
                    <span className='small text-muted'>Fills your schedule based on your availability with this offering</span>
               </div>}
          </>
     );
};
