      ...
      <Card className="shadow-sm mt-3" border="light">
        <Card.Body className="mt-2">
          <Row className="mt-1" style={{ textAlign: 'start' }}>
            <Col lg={12}>
              <span style={{ fontSize: '21px', display: 'flex', alignItems: 'center' }}>
              ...
              <br />
              <div className="mt-0">
                Slots will be only shown after the lead time, For examples if the online session
                starts 6:00 pm, and the lead time is 15 mins. So users can book only till 5:45 pm.
                Your users wont be able to book after the lead time
              </div>
            </Col>
          </Row>
          <Row
