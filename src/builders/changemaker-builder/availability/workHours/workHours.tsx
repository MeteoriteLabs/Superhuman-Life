...
const WorkHours: React.FC = () => {
    ...
    function handleTodaysSlots(todaysEvents: any, changeMakerAvailability: any) {
        const currentDateWorkHours =
            changeMakerAvailability &&
            changeMakerAvailability.length &&
        ...
        for (var i = 0; i < values?.length; i++) {
            ...
            if (
                ...
                for (let x = 0; x < val[daysOfWeek[dayIndex]].slots?.length; x++) {
                    if (
                        moment(fromTime, 'hh:mm:ss').isSameOrAfter(
                            moment(val[daysOfWeek[dayIndex]]?.slots[x]?.start_time, 'hh:mm:ss')
                        ) &&
                        moment(fromTime, 'hh:mm:ss').isBefore(
            ...
            <>
                ...
                <div style={{ borderRadius: '20px' }} className="text-center mt-3 p-0">
                    ...
                    <Row>
                        <Col lg={{ span: 8, offset: 4 }}>
                            {toast ? (
                                <Toaster
                                    handleCallback={() => setErrMsg('Successfully Added Slot!')}
                                    type={'success'}
                ...
                }
                {
                    ...
                    >
                        ...
                        >
                            <Modal.Title id="contained-modal-title-vcenter">
                                You cannot assign work hour for the date: {date} as you have marked
                ...
                }
                {
                    ...
                    >
                        ...
                        >
                            <Modal.Title id="contained-modal-title-vcenter">
                                You cannot assign work hour for the date: {workHourConflict?.date}{' '}
                                as you have marked every{' '}
