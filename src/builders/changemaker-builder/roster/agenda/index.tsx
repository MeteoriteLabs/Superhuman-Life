  ...
  return (
    <div className="text-left shadow-lg p-4" style={{ borderRadius: "15px" }}>
      ...
      {data?.workout_text !== null && (
        ...
        >
          <h5>
            <b>Workout Instructions in Text: </b>
          </h5>
          <div
            dangerouslySetInnerHTML={{ __html: `${data?.workout_text}` }}
          ></div>
        </div>
      )}
      <div className="mt-4">
              ...
              <Accordion.Collapse eventKey="2">
                <Card.Body>
                  {data?.mainmovement[0]?.type === "exercise" &&
                    data?.mainmovement?.map((item: any) => {
                      return (
                        <>
                          <div
                            className="shadow-lg p-3"
          ...
          {data?.cooldown?.length > 0 && (
            <Card>
              <Accordion.Toggle
                ...
                className="text-left"
                eventKey="3"
                onClick={() => toggleAccodian(active === 3 ? null : 3)}
              >
                <b>CoolDown</b>
                <Chevron
                  className={
