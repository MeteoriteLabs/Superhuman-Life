...
const AttendanceModal = (props: any) => {
  ...
  function handleAttendanceCalculations(data: any[], statusToCheck?: string) {
    const filteredData = data.filter(
      (session: any) => session.attendance === statusToCheck
    );
    ...
    >
      <Modal.Body style={{ maxHeight: "400px", overflow: "auto" }}>
            ...
            <Row className="">
              <Col className="pl-1 pr-1 text-center">
                <span className="small">
                  {padTo2Digits(attendanceData.length)}
                </span>
                <br />
              ...
              <Col className="pl-1 pr-1 text-center">
                <span className="small">
                  {handleAttendanceCalculations(attendanceData, "Attended")}
                </span>
                <br />
              ...
              <Col className="pl-1 pr-1 text-center">
                <span className="small">
                  {handleAttendanceCalculations(attendanceData, "Absent")}
                </span>
                <br />
        ...
        {attendanceData.length === 0 && (
          <div className="text-center mt-2">No Clients</div>
        )}
        {!showData ? (
          <div>Loading...</div>
        ) : (
                ...
                <Row className="mt-2 mb-2">
                  ...
                  <Col className="text-center">
                    <Row className="justify-content-between">
                      ...
                      <div
                        className={`border border-danger p-1 rounded-lg pl-2 pr-2 ${
