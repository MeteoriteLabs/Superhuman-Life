...
const RosterSettings: React.FC<{data: any[]}> = (props) => {
  ...
  const [updateSessionClassStatus] = useMutation(
    UPDATE_SESSION_BOOKING_STATUS,
    {
      onCompleted: () => {
        handleCloseStatus();
        ...
        >
          ...
          <Dropdown>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={handleShowMode}>
                Change Mode
              </Dropdown.Item>
              <Dropdown.Item onClick={handleShowStatus}>
                Cancel Class
              </Dropdown.Item>
              <Dropdown.Item onClick={handleShowDate}>
                Reschedule Date
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        ...
        >
          <Row>
            ...
            <Col lg={5}>
              <Row>
                <div className="shadow-lg p-4" style={{ borderRadius: "15px" }}>
                  {moment(data?.session?.start_time, "hh:mm a").format(
                    "hh:mm a"
                  )}
                </div>
