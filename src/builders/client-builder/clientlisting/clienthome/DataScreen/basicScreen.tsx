            ...
            <Row>
              ...
              <Col>
                <span style={{ color: "gray" }}>
                  Last Updated: 25/06/2021. 04:20 pm
                </span>
              </Col>
            </Row>
          </div>
          ...
          <Row className="ml-2 mr-2 mb-2">
            ...
            <Col>
              <Form.Control
                aria-label="Small"
                type="text"
                placeholder="In the heart of the city"
                aria-describedby="inputGroup-sizing-sm"
              />
            </Col>
          </Row>
  ...
  return (
    <div>
      <Row>
        <BasicCard
          title={"General"}
          color={handleProgressColor(100)}
          value={100}
          onClick={() => setGeneralModalShow(true)}
        />
        <BasicCard
          title={"Lifestyle"}
          color={handleProgressColor(60)}
          value={60}
        />
