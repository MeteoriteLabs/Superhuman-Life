...
function CardComp(props: any) {
  ...
  function FetchData(_variables: any = { id: props.resourceid }) {
  ...
  function FetchRating(_variables: any = { id: props.resourceid, clientid: last }) {
              ...
              {rating &&
                rating.map((d) => {
                  if (d.type === 'rpm') {
                    ...
                    return (
                      <div className="rounded border border-dark p-2" key={d.name}>
                  ...
                  if (d.type === 'mood') {
                    return (
                      <div className="rounded border border-dark p-2 rating2" key={d.name}>
                        <h6 className="ml-3">Mood</h6>
                        <img src={`/assets/ratingicons/${img[d.rating - 1]}`} alt="" />
                      </div>
                    );
                  }
                  return '';
