                ...
                >
                    <Card.Body>
                        <div className="text-center p-2">
                            <span style={{ color: '#414141', fontWeight: 'bold' }}>
                                {props.title}
                            </span>
                            <br />
                        </div>
                        ...
                        <div>
                            <Row>
                                ...
                                <Col lg={10}>
                                    ...
                                    <Row className="p-2">
                                        Lorem epsum Lorem epsumLorem epsumLorem epsumLorem
                                        epsumLorem epsum Lorem psum Lorem epsumLorem epsum
                                    </Row>
                                </Col>
                            </Row>
                        </div>
            ...
            <div>
                ...
                <div className="p-3" style={{ backgroundColor: '#FFEFC5', borderRadius: '15px' }}>
                    ...
                    <div className="w-95 ml-5 mr-5 mt-3 p-5">
                        <Slider {...settings}>
                            <PillarCard
                                imgProp={'/assets/salad-pillar.svg'}
                                title={'Eat Healthy'}
                            />
                ...
                <div className="p-3">
                    ...
                    <Row className="justify-content-center">
                        <HabitCard
                            imgProp={'/assets/siren-pillar.svg'}
                            title={'Off-track alerts'}
                        />
                        <HabitCard
                            imgProp={'/assets/community-pillar.svg'}
                            title={'Support from Community'}
                        />
                        <HabitCard
                            imgProp={'/assets/certificate-pillar.svg'}
                            title={'Note to future self'}
                        />
                        <HabitCard
                            imgProp={'/assets/money-pillar.svg'}
                            title={'Bet with a buddy'}
                        />
                    </Row>
                </div>
                <div className="p-3">
                    ...
                    <div
                        className="p-3"
                        style={{ backgroundColor: '#FFEFC5', borderRadius: '15px' }}
                    >
                        <Tabs
                            variant="pills"
                        ...
                        >
                            ...
                            <Tab eventKey="notCompleted" title="Not Completed"></Tab>
