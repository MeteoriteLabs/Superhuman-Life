          ...
          <Accordion defaultActiveKey="">
               <Card>
                    ...
                    <Accordion.Collapse eventKey="0">
                         <Card.Body>
                              <Build onChange={OnChangeWarmUp} buildId={1} value={props.value}/>
                         </Card.Body>
                    </Accordion.Collapse>
               </Card>
               <Card>
                    ...
                    <Card.Body>
                         <Build onChange={OnChangeMainMovement} buildId={2} value={props.value}/>
                    </Card.Body>
                    </Accordion.Collapse>
               </Card>
               <Card>
                    ...
                    <Card.Body>
                         <Build onChange={OnChangeCoolDown} buildId={3} value={props.value}/>
                    </Card.Body>
                    </Accordion.Collapse>
               </Card>
          </Accordion>
