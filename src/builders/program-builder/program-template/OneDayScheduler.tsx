...
//: React.FC<{type: string; sessionsIds: string[]; startDate: string; restDays: string[]; classType: string;}> 
    ...
    return (
       <div>
            <Row className="d-flex justify-content-center">
                <p style={{color: "#1A73E8", fontWeight: "bold", fontSize: "15px", textAlign: "center" }}>{moment(props.startDate).format('dddd')}<div style={{background: "#1A73E8", color: 'white',  borderRadius: '10%', padding: "10px", fontWeight: "bold", fontSize: "15px", position: "relative"}}>{moment(props.startDate).format("MMM Do, YY")}</div> </p>
            </Row>
            <Row>
                    ...
                    >
                        {hours.map((currentHour) => {
                            return (
                                <div key={currentHour}>
                                    <Row>
                                        <Col lg={1} sm={1} md={1} className="p-3">
                                            {handle12HourFormat(currentHour)}
                                        </Col>
                                        <Col lg={11} sm={11} md={11} className="border p-3"></Col>
                                    </Row>
                                </div>
                            );
                        })}
...
export default OneDayScheduler;
...
//                                                         ? moment(event.sessionDate).format(
//                                                               'Do, MMM YY'
//                                                           )
//                                                         : `Day - ${event.day}`
//                                                 }
