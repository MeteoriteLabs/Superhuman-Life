...
const ClientHomePage = React.lazy(
  () => import("./builders/client-builder/clientlisting/client")
);
...
const ClassicProgramSchedulerPage = React.lazy(
  () => import("./builders/session-builder/Fitness/Classic/scheduler")
);
const PTProgramSchedulerPage = React.lazy(
  () => import("./builders/session-builder/Fitness/PT/scheduler")
);
const GroupProgramSchedulerPage = React.lazy(
  () => import("./builders/session-builder/Fitness/Group/scheduler")
);
const CustomProgramSchedulerPage = React.lazy(
  () => import("./builders/session-builder/Fitness/Custom/scheduler")
);
...
const clientSchedulerPage = React.lazy(
  () => import("./builders/changemaker-builder")
);
const AvailabilityPage = React.lazy(
  () => import("./builders/changemaker-builder/availability")
);
const RosterPage = React.lazy(
  () => import("./builders/changemaker-builder/roster")
);
...
const GoogleAuthCallbackPage = React.lazy(
  () => import("./pages/register/oAuthLogins/googleAuthCallback")
);
        ...
        {token ? (
          <Suspense fallback={<Loader/>}>
            ...
            <Switch>
              ...
              <Route
                path="/classic/session/scheduler"
                component={ClassicProgramSchedulerPage}
              />
              <Route
                path="/pt/session/scheduler"
                component={PTProgramSchedulerPage}
              />
              <Route
                path="/group/session/scheduler"
                component={GroupProgramSchedulerPage}
              />
              <Route
                path="/custom/session/scheduler"
                component={CustomProgramSchedulerPage}
              />
              <Route
              ...
              <Route
                ...
                component={ChannelProgramSchedulerPage}
              />
