  ...
  return (
    <Fragment>
      ...
      <input
        ...
        min={moment().format('YYYY-MM-DD')}></input>

      {/* Offering selector */}
      <DropdownButton
        title={offeringSelectedName !== null ? offeringSelectedName : 'Select offering'}>
      ...
      <div>
        {Sessions && Sessions.length ? (
          <>
          {/* Morning sessions */}
            {morningSession && morningSession.length ? <h5>Morning sessions</h5> : null}
            <Row>
              {morningSession && morningSession.length
                ? morningSession.map((currentValue) => (
                    <Button
                      ...
                      className="m-1">{`${getTimeIn12HourFormat(
            ...
            {/* Afternoon sessions */}
            {noonSessions && noonSessions.length ? <h5>Mid-day sessions</h5> : null}
            <Row>
            ...
            {/* Evening sessions */}
            {eveningSessions && eveningSessions.length ? <h5>Evening sessions</h5> : null}
            <Row>
