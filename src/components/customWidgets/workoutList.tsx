...
const ProgramList = (props: any) => {
   ...
   `;
     ...
     function handleSelectedEquipmentAdd(name: any, id: any, level: any, description: any, intensity: any, equipment: any, discipline: any) {
          const values = [...selected];
          let a = values.find((e) => e.id === id);
          let b = values.length === 0;
          if (!a && b){
               values.push({ name: name, id: id, level: level, description: description, intensity: intensity, equipment: equipment, discipline: discipline  }); 
               setSelected(values);
          }
                              ...
                              <Container className="pl-0">
                                   <div 
                                        ...
                                        onClick={(e) => {e.preventDefault(); 
                                             handleSelectedEquipmentAdd(workout.name, workout.id, workout.level, workout.description, workout.intensity, workout.equipment, workout.discipline);
                                        }}>
                                        <div>
                                             <Row>
                    ...
                    {selected.map((val) => {
                         return (
                              <div>
                                   ...
                                   <Col lg={4} style={{ top: '50%', transform: 'translateY(40%)'}}>
                                   <div>
