...
const ClientsSelect = (props: any) => {
  ...
  `;
     ...
     function FetchMuscleGroupList(_variable: {} = {filter: " "}){
          useQuery(CLIENTS_QUERY, {variables: _variable, onCompleted: loadMuscleGroupList, skip: !searchInput});
      }
     ...
     return (
          <>
               ...
               <InputGroup>
                    <FormControl aria-describedby="basic-addon1" placeholder="Search For Clients"  id="muscleGroup" ref={inputField}
                         ...
                         {clients?.slice(0,5).map((client) => {
                              return (
                                   ...
                                   <option style={{cursor: 'pointer'}}
                                        ...
                                        value={client.id}
                                        onClick={(e) => {e.preventDefault(); handleSeletedMuscleGroupAdd(client.name, client.id);
                                             }}>
                                        {client.name}
                                   </option>
                                   </Container>
                              ...
                              return (
                                   <div className="text-center mt-2 mr-2" style={{ 
                                        ...
                                        <i className="close fas fa-times" 
                                             ...
                                             onClick={() => handleSelectedMuscleGroupRemove(val.name)}></i>
                                   </div>
                              )
                         })}
                    </> 
