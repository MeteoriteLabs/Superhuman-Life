  ...
  return (
    <>
      {props ? (
        <div
          className={
            props.show ? 'side-drawer open col-lg-7 col-sm-8' : 'side-drawer col-lg-7 col-sm-8'
          }>
          <Row>
            <Col lg={1}>
            ...
            <Col lg={11}>
              <div
                ...
                <div style={{ height: '100vh', width: '40vh' }}>
                  {props.details.type !== 'Cohort' && props.details.type !== 'Classic Class'}
                  <Card className="rounded ml-5 mt-5 d-flex preview__card">
                    <Row>
                      <Col lg={12}>
                        <DisplayImage
                          imageName={props.details.thumbnailId ? props.details.thumbnailId : ''}
                    ...
                    <Row>
                      <Col lg={5} sm={5} className="ml-1">
                        <p style={{ fontSize: '0.7rem' }}>{props.details.name}</p>
                        <p
                        ...
                        {props.details.address ? (
                          <>
                            <img
                              ...
                              style={{ height: '1.5rem' }}
                            />
                            <p style={{ fontSize: '0.7rem' }}>{props.details.address.address1}</p>
                          </>
                        ) : null}
                      </Col>
                    </Row>
                          ...
                          <Col lg={12} sm={12}>
                            ...
                            props.details?.type === 'On-Demand PT' ? (
                              <div className="d-flex " style={{ fontSize: '0.7rem' }}>
                                <div className="px-2">
                                  {props.details?.ptoffline ? props.details?.ptoffline : 0}
                                </div>
                                <div className="px-3">
                                  {props.details?.ptonline ? props.details?.ptonline : 0}
                                </div>
                              </div>
                            ) : null}
                            {props.details?.type === 'Group Class' ? (
                              <div className="d-flex " style={{ fontSize: '0.7rem' }}>
                                <div className="px-2">
                                  {props.details.groupoffline ? props.details.groupoffline : 0}
                                </div>
                                <div className="px-3">
                                  {props.details.grouponline ? props.details.grouponline : 0}
                                </div>
                              </div>
                            ) : null}
                          </Col>
                      ...
                      <Col lg={4} className="ml-1">
                        ...
                        props.details?.pricing[0].mrp === 'free' ? (
                          ...
                          <p style={{ fontSize: '0.7rem' }}>
                            ...
                            props.details?.pricing.length
                              ? `${
                                  props.details.pricing.find((curr) => curr.duration === 30).mrp
                                } Monthly`
                              : null}
                          </p>
                        )}
